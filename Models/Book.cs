...
public partial class Book
{
    ...
    [MaxLength(35, ErrorMessage = "ID cannot exceed 60 characters.")]
    public string Id { get; set; } = null!;

    [Required(ErrorMessage = "Title field is required.")]
    [MaxLength(45, ErrorMessage = "Title length cannot exceed 35 characters.")]
    ...
    [MaxLength(30, ErrorMessage = "Genre cannot exceed 20 characters.")]
    ...
    [MaxLength(30, ErrorMessage = "Editorial cannot exceed 20 characters.")]
